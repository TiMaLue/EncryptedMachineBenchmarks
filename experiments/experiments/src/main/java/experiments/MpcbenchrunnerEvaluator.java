...
public class MpcbenchrunnerEvaluator implements IExperimentSetEvaluator {
	...
	private void startBenchmarkProcess(File inputFile, File outputFile) throws InterruptedException, ExperimentEvaluationFailedException {
...
//		pb.inheritIO();
	...
	@Override public void evaluate(ExperimentDBEntry experimentEntry, IExperimentIntermediateResultProcessor processor)
